...
- **Pattern Detection**: Identify trends, anomalies, and correlations across disparate data sources
- **Contextual Analysis**: Connect quantitative data with qualitative business context
- **Signal vs. Noise**: Distinguish meaningful insights from statistical noise
- **Multi-dimensional Thinking**: Analyze across time, geography, product lines, customer segments

### 2. **Strategic Storytelling**
- **Narrative Construction**: Build compelling data-driven narratives
