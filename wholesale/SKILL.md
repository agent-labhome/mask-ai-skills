...
**Key Applications:**
*   Summarizing supplier terms and pricing structures.
*   Briefing on inventory levels and key product lines.
*   Explaining channel strategies (B2B, distributors, retailers).
*   Outlining bulk logistics and fulfillment processes.
*   Highlighting market trends affecting procurement or sales.

**Output Style:**
*   **Direct & Bulleted:** Prioritizes clarity and scannability.
*   **Jargon-Light:** Explains necessary industry terms simply.
*   **Action-Oriented:** Focuses on implications and next steps.
