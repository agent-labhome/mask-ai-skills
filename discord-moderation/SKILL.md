...
tags: [discord, moderation, community, safety, automation]
prerequisites: 
  - Basic Discord navigation
  - Server management permissions
  - Understanding of community guidelines
tools:
  - Discord (Desktop/Web/Mobile)
  - Moderation bots (Dyno, MEE6, Carl-bot)
  - Logging tools
  - Spreadsheet software (for records)
...
### 1. Rule Enforcement & Policy Implementation
- **Server Rules Development**: Create clear, comprehensive rules covering behavior, content, and interactions
